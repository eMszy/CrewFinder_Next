		...
		<div className={classes.content}>
			<div className={classes.Content_Height}>
				<div>
					...
					<p>
						...
						kerül be a szakmánkba és új nyitott pozíciók jelennek meg egyik
						napról a másikra, hisz, mint tudjuk, a filmezésben egy állandó van,
						az pedig a változás.
					</p>
					<p>
					...
					<p>Íme néhány szó rólunk:</p>
				</div>
			</div>
			<hr />
			<div className={classes.Content_Height}>
				<div className={classes.Picture_Right}>
					<h2>Vilonya Norbert</h2>
				...
				<div>
					<p>
						...
						végigjártam a ranglétrát, és 2012-től már 2nd AD, illetve 1st
						AD-ként dolgoztam. Az elmúlt 14 évben volt szerencsém olyan
						produkciókban dolgozni, mint például The Terror, Force 2, Spy,
						Hercules, 47 Ronin, The Borgias.
					</p>
					<p>
			...
			<div className={classes.Content_Height}>
				...
				<div>
					...
					<p>
						Volt lehetőségem bepillantást nyerni, hogy mire vagy kire van
						szüksége a stábtagoknak, produkciónak és hogy ezek milyen nehezen
						találkoznak. Elhatároztam, hogy létrehozunk egy rendszert, mely
						segít ennek megvalósulásában! Rengeteg tervünk és ötletünk van még a
						jövőre nézve, hiszen Magyarország mára nem csak kiváló kiszolgáló
						személyzetet képes adni a külföldi produkciók számára, hanem nívós
						magyar filmeket és díjakat is tudhatunk a magunkénak.
					</p>
				</div>
			</div>
		</div>
